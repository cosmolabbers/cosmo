...
from cosmo import defaults
from cosmo.controllers import create_routes
...
def _configure_from_environment(app):
    ...
    the COSMO_SETTINGS environment variable.

    Don't complain if the variable is unset.
    """
    app.config.from_envvar("COSMO_SETTINGS", silent=True)
...
def _configure_logging(app):
    ...
    if app.testing or app.debug:
        ...
        configured_logger = getLogger("cosmo")
